...
cd /home/xjturm/DX_autoaim/build/
BaudRate=115200
while true
do
    ...
    > /dev/$name
    if ! `ps aux | grep -v grep | grep /home/xjturm/DX_autoaim/build/infantry_new`
    then
            echo 'bfjg' | sudo -S chmod 666 /dev/ttyACM0
            /home/xjturm/DX_autoaim/build/infantry_new /dev/$name $BaudRate
    fi
